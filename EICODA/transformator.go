...
type Transformator interface {
	Transform(model *models.Model, writeFile bool) (string, error)
}
...
func (t *DockerComposeTransformator) Transform(model *models.Model) (string, error) {
...
func (t *KubernetesTransformator) Transform(model *models.Model) (string, error) {
	// Implement the transformation logic and return the transformed model as a string
...
func (t *RabbitMqTransformator) Transform(model *models.Model) (string, error) {
	// Implement the transformation logic and return the transformed model as a string
